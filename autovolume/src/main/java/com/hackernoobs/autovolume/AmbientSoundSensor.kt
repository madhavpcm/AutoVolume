package com.hackernoobs.autovolume
...
class AmbientSoundSensor(private val context: Context, private val onVolumeChange: (Int) -> Unit) {
...
//                    autoVolumeCtx.adjustVolume(buffer)
                    val newVolume = autoVolumeCtx.adjustVolumeWithSTALTA(bufferQueue)
